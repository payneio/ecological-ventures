...
class ProblemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create problem" do
    assert_difference("Problem.count") do
      post problems_url, params: { problem: { description: @problem.description, name: @problem.name } }
    end
  ...
  test "should update problem" do
    patch problem_url(@problem), params: { problem: { description: @problem.description, name: @problem.name } }
