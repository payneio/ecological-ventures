...
class SolutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create solution" do
    assert_difference("Solution.count") do
      post solutions_url, params: { solution: { cover_photo: @solution.cover_photo, description: @solution.description, link: @solution.link, name: @solution.name } }
    end
  ...
  test "should update solution" do
    patch solution_url(@solution), params: { solution: { cover_photo: @solution.cover_photo, description: @solution.description, link: @solution.link, name: @solution.name } }
